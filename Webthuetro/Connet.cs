...
namespace Webthuetro
{
    public class Connet
    {
        public string connect1 = @"Data Source=DESKTOP-LN0GVJH;Initial Catalog=Web_thue_tro;Integrated Security=True;TrustServerCertificate=True";
        public SqlConnection con =new SqlConnection(@"Data Source=DESKTOP-LN0GVJH;Initial Catalog=Web_thue_tro;Integrated Security=True;TrustServerCertificate=True");
