    ...
    <div id="detail">
        <div class="container">
            <div class="container-detail">
                ...
                <div class="comment" style="position: absolute; background-color: #fff; top: 272px; left: 732px; width: 468px; padding: 10px; margin-bottom: 20px; height: 500px; overflow-y: auto; border: 1px solid; border-radius: 4px; box-shadow: #ccc 0px 2px 10px 0px;">
                    <hr />
